...
(function() {
  var BLANK_LINES, accumulateNode, analyzeClass, anonymousFunctions, calculateScore, churn, classFunctions, countNodes, exec, fs, getMethods, glob, merge, methods, nextNode, nodes, objectLiteralFunctions, readFile, score, scoreEval, scoreIfElse, scoreSwitch, variableFunctions,
    _this = this;
  ...
  */
  ...
  scoreEval = function(exp, score) {
    var base, _ref;

    if (score == null) {
      score = 0;
    }
    if (base = (_ref = exp.variable) != null ? _ref.base : void 0) {
      if (base.value === 'eval') {
        score += 25;
      }
    }
