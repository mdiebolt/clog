...
(function() {
  var CoffeeLint, analyze, churn, clamp, coffee, complexityConfig, count, cyclomaticComplexity, execSync, files, fs, functionLength, functionLengthConfig, glob, gpa, letterGrade, longFilePenalty, nestedCoffeeScriptPattern, report, rules, tokenComplexity, tokens, tokensForFile, version;
  ...
  functionLength = function(filePath) {
    var file, output;
    file = fs.readFileSync(filePath, "utf8");
    return output = CoffeeLint.lint(file, functionLengthConfig).reduce(function(hash, description) {
      var lineRange;
