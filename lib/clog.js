...
(function() {
  var BLANK_LINES, accumulateNode, analyzeClass, anonymousFunctions, churn, classFunctions, countNodes, exec, fs, getMethods, glob, merge, methods, nextNode, nodes, objectLiteralFunctions, readFile, variableFunctions,
    _this = this;
